...
/**
 * Notification component to display toast notifications
 */
...
const NotificationItem: React.FC<NotificationItemProps> = ({ notification, onClose }) => {
  ...
  return (
    <div
      className={`${bgColors[type]} border-l-4 p-4 rounded-lg shadow-lg min-w-[320px] max-w-md animate-slide-in`}
      role="alert"
    >
