...
from utils.metrics_registry import get_or_create_counter, get_or_create_histogram, get_or_create_gauge

logger = get_logger(__name__)

router = APIRouter(prefix="/metrics", tags=["metrics"])

# Define metrics (using registry to prevent duplicate registration)
...
task_operations_total = get_or_create_counter(
    'task_operations_total',
    'Total task operations',
    ['operation', 'status']
)

agent_operations_total = get_or_create_counter(
